...
<body class="text-center" style="background-color: #864879">
    <div class="container mt-5">
        ...
        <main class="form-signin">
            <form action="proses_login.php" method="POST">
                <div class="card-header" style="background-color: #E9A6A6;"><h1>TOKO ONLINE</h1></div>
                ...
                <a href="tampil_petugas.php">DATA ADMIN/PETUGAS</a><br>
                <a href="tambah_petugas.php">Daftar Akun Admin/Petugas</a>
                <br><br>
