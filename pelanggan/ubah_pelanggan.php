...
<body style="background-color: #DED9C4">
    <?php 
        include "koneksi.php";
    ...
    <div class="container">
        ...
        <div class="card-header" style="background-color: #96C7C1;"><h1>Edit Profile</h1></div>
        <div class="card-body">
        <a class="btn btn-secondary" href="profil_pelanggan.php" role="button">Back to Profile</a><hr>
