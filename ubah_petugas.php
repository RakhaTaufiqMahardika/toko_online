...
<body style="background-color: #864879">
    ...
    <div class="container">
        ...
        <div class="card-header" style="background-color: #E9A6A6;"><h1>Edit Profile</h1></div>
        <div class="card-body">
        <a class="btn btn-secondary" href="profil_petugas.php" role="button">Back to Profile</a><hr>
