...
<body style="background-color: #864879">
    ...
    <div class="container">
        <div class="card" style="margin: 20px;">
            <div class="card-header" style="background-color: #E9A6A6;"><h1>Ubah Produk</h1></div>
            <div class="card-body">
            <a class="btn btn-secondary" href="data_produk.php" role="button">Back to Data Produk</a><hr>
