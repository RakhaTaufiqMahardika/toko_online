...
<body style="background-color: #864879">
    <div class="container">
    <div class="card" style="margin: 20px;">
        <div class="card-header" style="background-color: #E9A6A6;"><h1>Tambah Produk</h1></div>
        <div class="card-body">
        <a class="btn btn-secondary" href="data_produk.php" role="button">Back to Data Produk</a>
        <hr>
        <form action="proses_tambah_produk.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-2">
                ...
                <textarea type="text" name="deskripsi" class="form-control" placeholder="Masukkan deskripsi produk" required></textarea>
            </div>
            <div class="mb-2">
